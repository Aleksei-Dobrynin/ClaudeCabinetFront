...
const BaseDocumentStatusView: FC<DocumentStatusTableProps> = observer((props) => {
    ...
    <Container maxWidth='xl' sx={{ mt: 3 }}>
      <Grid container spacing={3}>
        <Grid item md={props.isPopup ? 12 : 6}>
          <form data-testid="DocumentStatusForm" id="DocumentStatusForm" autoComplete='off'>
            <Card component={Paper} elevation={5}>
              <CardHeader title={
                <span id="DocumentStatus_TitleName">
                  {translate('label:DocumentStatusAddEditView.entityTitle')}
                </span>
              } />
              <Divider />
              <CardContent>
...
export default BaseDocumentStatusView;
