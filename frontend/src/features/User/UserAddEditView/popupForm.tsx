...
const UserPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:UserAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
        <UserAddEditBaseView
          isPopup={true}
        >
