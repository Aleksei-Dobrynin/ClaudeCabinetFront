...
export const schema = yup.object().shape({
  ...
  template: yup.string(),
  iddocumenttemplate: yup.number().notOneOf([0], "Required field").required("Required field"),
  idlanguage: yup.number().notOneOf([0], "Required field").required("Required field"),
});
