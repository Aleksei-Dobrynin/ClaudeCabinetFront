...
import { deleteApplication, getMyArchiveApplications } from "api/Application";
...
class ApplicationListStore extends BaseStore {
  ...
  @observable filter: "all" | "need_action" | "accepted" | "done" = "all"
  @observable openPanelView: boolean = false;
  ...
  changeOpenPanelView(flag: boolean, id: number){
    this.openPanelView = flag
    this.currentId = id;
  }
  ...
  setFilter(filter: "all" | "need_action" | "accepted" | "done") {
    this.filter = filter
  }
