...
import storeList from "./../LanguageListView/store";
...
const FastInputView: FC<LanguageProps> = observer((props) => {
  ...
  const columns = [
    {
                ...
                },
                {
                    field: 'updated_by',
                    width: null, //or number from 1 to 12
                    headerName: translate("label:LanguageListView.updated_by"),
                },
                {
                    field: 'name_kg',
                    width: null, //or number from 1 to 12
                    headerName: translate("label:LanguageListView.name_kg"),
                },
                {
                    field: 'description_kg',
                    width: null, //or number from 1 to 12
                    headerName: translate("label:LanguageListView.description_kg"),
                },
                {
                    field: 'text_color',
                    width: null, //or number from 1 to 12
                    headerName: translate("label:LanguageListView.text_color"),
                },
                {
                    field: 'background_color',
                    width: null, //or number from 1 to 12
                    headerName: translate("label:LanguageListView.background_color"),
                },
                {
                    field: 'description',
                    width: null, //or number from 1 to 12
                ...
                },
                {
                    field: 'created_at',
                    width: null, //or number from 1 to 12
                    headerName: translate("label:LanguageListView.created_at"),
                },
                {
                    field: 'created_by',
                    width: null, //or number from 1 to 12
                    headerName: translate("label:LanguageListView.created_by"),
                },
                {
                    field: 'updated_at',
                    width: null, //or number from 1 to 12
                    headerName: translate("label:LanguageListView.updated_at"),
                },
  ...
  return (
    <Container>
      <Card component={Paper} elevation={5}>
        <CardContent>
          <Box id="Language_TitleName" sx={{ m: 1 }}>
            <h3>{translate("label:LanguageAddEditView.entityTitle")}</h3>
          </Box>
          <Divider />
                    ...
                    {storeList.isEdit === false && (
                      <>
                        ...
                        <IconButton
                          ...
                          onClick={() => storeList.deleteLanguage(entity.id)}
                        >
                          <DeleteIcon />
                        </IconButton>
                      </>
