...
import { deleteNotificationLog } from "api/NotificationLog";
import { NotificationLog } from "constants/NotificationLog";
import { getNotificationLogs } from "api/NotificationLog";

class NotificationLogListStore extends BaseStore {
  @observable data: NotificationLog[] = [];
...
export default new NotificationLogListStore();
