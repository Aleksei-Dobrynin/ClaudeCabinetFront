...
import { deleteAuthType } from "api/AuthType";
import { AuthType } from "constants/AuthType";
import { getAuthTypes } from "api/AuthType";

class AuthTypeListStore extends BaseStore {
  @observable data: AuthType[] = [];
...
export default new AuthTypeListStore();
