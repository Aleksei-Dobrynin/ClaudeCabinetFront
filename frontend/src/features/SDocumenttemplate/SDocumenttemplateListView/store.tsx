...
import { deleteSDocumenttemplate } from "api/SDocumenttemplate";
import { SDocumenttemplate } from "constants/SDocumenttemplate";
import { getSDocumenttemplates } from "api/SDocumenttemplate";

class SDocumenttemplateListStore extends BaseStore {
  @observable data: SDocumenttemplate[] = [];
  ...
  deleteSDocumenttemplate = (id: number) => {
    this.showConfirmDialog(
      ...
      async () => {
        this.apiCall(
          () => deleteSDocumenttemplate(id),
          () => {
            this.loadSDocumenttemplates();
...
export default new SDocumenttemplateListStore();
