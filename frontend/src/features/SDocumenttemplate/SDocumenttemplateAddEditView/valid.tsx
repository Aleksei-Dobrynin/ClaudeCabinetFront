...
export const schema = yup.object().shape({
  ...
  nameKg: yup.string(),
  descriptionKg: yup.string(),
  textColor: yup.string(),
  backgroundColor: yup.string(),
  name: yup.string(),
  description: yup.string(),
  code: yup.string(),
  idcustomsvgicon: yup.number().notOneOf([0], "Required field").required("Required field"),
  iconcolor: yup.string(),
  iddocumenttype: yup.number().notOneOf([0], "Required field").required("Required field"),
});
