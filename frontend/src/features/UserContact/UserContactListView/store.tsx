...
import { deleteUserContact } from "api/UserContact";
import { UserContact } from "constants/UserContact";
import { getUserContacts } from "api/UserContact";

class UserContactListStore extends BaseStore {
  @observable data: UserContact[] = [];
...
export default new UserContactListStore();
