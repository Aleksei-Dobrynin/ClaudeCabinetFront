...
import { deleteArchObject } from "api/ArchObject";
import { ArchObject } from "constants/ArchObject";
import { getArchObjects } from "api/ArchObject";

class ArchObjectListStore extends BaseStore {
  @observable data: ArchObject[] = [];
...
export default new ArchObjectListStore();
