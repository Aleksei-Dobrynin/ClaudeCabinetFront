                    ...
                    <Stack>
                      <Stack direction="row" spacing={0.5} alignItems="center">
                        ...
                        <Typography component="span" variant="h4" sx={{ fontWeight: 400 }}>
                          {MainStore.currentUser?.lastName + " " + MainStore.currentUser?.firstName}
                        </Typography>
                      </Stack>
                    </Stack>
                    <Divider />
                    ...
                    <Box sx={{ p: 2, pt: 0 }}>
                      ...
                      >
                        <ListItemButton
                          ...
                          onClick={(event) => handleListItemClick(event, 5, '/user/Settings')}
                        >
                          <ListItemIcon>
                            <IconSettings stroke={1.5} size="1.3rem" />
                          </ListItemIcon>
                          <ListItemText primary={<Typography variant="body2">{t('label:authorization.myprofile')}</Typography>} />
                        </ListItemButton>
                        <ListItemButton
                          sx={{ borderRadius: `${10}px` }}
                          selected={store.selectedIndex === 3}
                          onClick={(event) => handleListItemClick(event, 3, '/user/UserProfile')}
                        >
                          <ListItemIcon>
                            <IconSettings stroke={1.5} size="1.3rem" />
                          </ListItemIcon>
                          <ListItemText primary={<Typography variant="body2">{t('label:authorization.profileSettings')}</Typography>} />
                        </ListItemButton>
                        <ListItemButton
                          sx={{ borderRadius: `${10}px` }}
                        ...
                        >
                          ...
                          <ListItemText primary={<Typography variant="body2">{t("common:goOut")}</Typography>} />
                        </ListItemButton>
                      </List>
                    </Box>
                  </PerfectScrollbar>
